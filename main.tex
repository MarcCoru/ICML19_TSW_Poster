...
%		\vspace{1em}
	...
	\node[below=of f, label={[yshift=.5em]below:\verytiny cereal vegetation model by \citet{Large1954}}](large){\includegraphics[width=14.5cm]{images/Large1954_cerial_growth_stages.png}};
	...
	\node[below=of label, xshift=-3.5em, yshift=1em, rotate=0, text=tumgraydark](yield){crop yield?};
	\node[below=of label, text=tumgraydark](prod){production?};
	\node[below=of label, xshift=3.5em, yshift=1em, text=tumgraydark](health){crop health?};
